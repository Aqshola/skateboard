            ...
            <AnimatePresence>
              {showDesc && (
                ...
                >
                  ...
                  Molestiae soluta laboriosam nulla provident modi recusandae
                  quod obcaecati iste unde officiis minus rerum fuga illum
                  perferendis, dolorum, iusto ad quis quidem quisquam! Odio
                  excepturi reprehenderit repellendus possimus, mollitia
                  laboriosam consequatur laborum hic tenetur rem sint adipisci
                  cumque ducimus. Sunt distinctio facilis laborum, saepe dicta
                  recusandae officiis repellat beatae dignissimos cupiditate
                  dolores, illum accusantium delectus, nesciunt neque
                  voluptates. Sed quasi consequatur consectetur fugiat
                  temporibus! Voluptas ullam temporibus ipsam, eveniet quos
                  magni perferendis qui, veritatis natus nemo quidem, vel itaque
                  aut quas commodi accusamus assumenda dicta? Accusantium quos
                  enim eum asperiores placeat quasi!
                </motion.p>
              )}
            </AnimatePresence>
          </div>
